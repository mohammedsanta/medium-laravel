<div class="flex justify-between items-center border-y pt-2 pb-2">
    ...
    <div class="flex items-center gap-2 ml-2">
        ...
        <button class="flex gap-2">
            <svg width="24" height="24" viewBox="0 0 24 24" class="vv">
    ...
    <div class="flex items-center gap-6 mr-2">
        ...
        <button>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="ly">
